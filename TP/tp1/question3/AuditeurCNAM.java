...
public class AuditeurCNAM {
    ...
    private String regEx = "[- ]";// trouver ce qui cotient '-' ou u espace vide.
    ...
    public String login() {
        ...
        if(nom != ""){
            String tempNom = Normalizer.normalize(nom, Normalizer.Form.NFD).replaceAll("[^\\p{ASCII}]", ""); //pour remplacés les caractères accentués par des caractères non accentués
    ...
    /**
     * Changement du nom de l'auditeur.
     * 
     */
