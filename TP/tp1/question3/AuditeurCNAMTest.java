...
public class AuditeurCNAMTest extends junit.framework.TestCase {
    ...
    public void test_nom_long_avec_special() {
        question3.AuditeurCNAM auditeur1 = new question3.AuditeurCNAM("ChAnT-Lé",
                "TeSt", "12345");
        assertEquals("ChAnT-Lé", auditeur1.nom());
        assertEquals("TeSt", auditeur1.prenom());
        assertEquals("chant__t", auditeur1.login());
    }

    public void test_nom_avec_special() {
        question3.AuditeurCNAM auditeur1 = new question3.AuditeurCNAM("à-éc",
                "èest", "12345");
        assertEquals("à-éc", auditeur1.nom());
        assertEquals("èest", auditeur1.prenom());
        assertEquals("a_ec_è", auditeur1.login());
    }
}
